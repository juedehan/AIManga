...
def load_system_prompts(whcihagent:str):
    systemprompt = whcihagent + "_sysprompt"
    try:
        system_prompt_path = get_abs_path(prompts_conf[systemprompt])
    except KeyError as e:
        logger.error(f"[load_system_prompts]在yaml配置项中没有配置项")
        raise e
